...
e=function(){var a=window.location;window.onhashchange=function(b){noop("has chnaged :: ",b,a.hash);b="#"+b.oldURL.split("#")[1];noop(" old hash is  :: ",b,b.length);d(b)};d()};noop(" router is runnign");return{when:function(b,c){b="#"==b.trim().charAt(0)?b:"#"+b;a[b]=c;return this},done:function(){noop("routes :: ",a);e()}}}();